...
namespace Deepayment\Sdk;

final class Rules
{
    /** Top-level create-order field rules, from protocol/data/request-rules.json. */
    public const CREATE_REQUIRED_TEXT_FIELDS = ['merchantOrderNo', 'currency'];
    public const AMOUNT_PATTERN = '/^(0|[1-9][0-9]{0,15})(\.[0-9]{1,2})?$/';
    public const WEBHOOK_URL_PREFIX = 'https://';

    public const METHOD_EXTRA_FIELDS = [
        'APPLE_PAY' => 'applePay',
        'BANK_CARD' => 'bankCard',

...
[`protocol/`](https://github.com/deepayment/sdk-php/tree/main/protocol/) is the cross-language source of truth; the Go,
...
```php
use Deepayment\Sdk\ApiException;
use Deepayment\Sdk\Client;
use Deepayment\Sdk\RequestException;
use Deepayment\Sdk\ResponseException;
use Deepayment\Sdk\TransportException;
...
[`protocol/merchant-api.md`](https://github.com/deepayment/sdk-php/blob/main/protocol/merchant-api.md#client-side-validation).
...
documentation at <https://docs.deepayment.com>; its examples map one to one onto this
SDK. The wire protocol is in
[`protocol/webhook.md`](https://github.com/deepayment/sdk-php/blob/main/protocol/webhook.md) and
[`protocol/merchant-api.md`](https://github.com/deepayment/sdk-php/blob/main/protocol/merchant-api.md). Key points:
...
[`protocol/testdata`](https://github.com/deepayment/sdk-php/tree/main/protocol/testdata/): `Signature-Input`, the signature
